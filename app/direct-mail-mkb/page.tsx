      ...
      <div style={{ fontFamily: 'var(--font-sans)', background: 'var(--paper)', minHeight: '100vh', color: 'var(--ink)' }}>
        ...
        <nav style={{ borderBottom: '1px solid var(--line)', padding: '16px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, background: 'var(--paper)', zIndex: 100 }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
            <Link href="/flyers-versturen-nieuwe-bewoners" style={{ fontSize: '12px', color: 'var(--muted)', textDecoration: 'none', fontFamily: 'var(--font-mono)' }}>Nieuwe bewoners</Link>
            <Link href="/flyers-versturen-kapper" style={{ fontSize: '12px', color: 'var(--muted)', textDecoration: 'none', fontFamily: 'var(--font-mono)' }}>Branches</Link>
