...
modify files in app/, components/, lib/. You are explicitly forbidden from touching tests/.
...
2. **Read** existing app/, components/, lib/ code for patterns, interfaces, and conventions
